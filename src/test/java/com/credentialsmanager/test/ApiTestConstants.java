...
public abstract class ApiTestConstants {
    ...
    protected static final String CHANGE_INFORMATION_URL = BASE_PATH_USER + CHANGE_INFORMATION;
    ...
    protected static final String CHANGE_EMAIL_URL = BASE_PATH_USER + CHANGE_EMAIL;
